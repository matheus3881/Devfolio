...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Aplicação completa voltada para gestão educacional e inovação acadêmica.",
    ...
    >
      ...
      <div className="mx-auto w-full max-w-6xl flex-1 flex flex-col justify-center gap-10 py-6 lg:flex-row lg:items-center lg:gap-16 lg:py-0">
        ...
        <div className="flex flex-col lg:flex-1">
          ...
          >
            Desenvolvo produtos digitais e sistemas inteligentes que transformam problemas complexos
            em experiências simples — com foco em{" "}
        ...
        <div className="hidden lg:flex lg:w-[340px] lg:shrink-0 xl:w-[380px]" aria-hidden="true">
          {/*
            ...
            <div className="relative">
              ...
              */}
              ...
              >
                ...
                <span className="font-mono text-[10px] text-foreground/70">matheus.dev</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-5 py-24 lg:px-8 lg:py-32">
        ...
        <div className="reveal flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="lg:max-w-[54%]">
            <p className="font-mono text-xs uppercase tracking-[0.15em] text-primary">01 / Sobre</p>
            <h2
          ...
          <div className="flex flex-col gap-5 lg:max-w-[38%] lg:pb-2">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm leading-7 text-muted-foreground">
                ...
                <span className="font-semibold text-foreground">IA aplicada</span> e construção de
        ...
        <div className="reveal grid gap-14 lg:grid-cols-[1fr_260px] lg:gap-20">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-base leading-[1.85] text-muted-foreground">
              Minha trajetória passa por backend, automação e construção de interfaces. Hoje, meu
              foco está em explorar como{" "}
            ...
            <p className="text-base leading-[1.85] text-muted-foreground">
              Gosto de trabalhar em problemas difíceis onde a tecnologia tem impacto real — do
              primeiro commit ao produto em produção.
            </p>
              ...
              {[
                {
                  ...
                  body: "Código que serve ao usuário, não ao ego do dev.",
                },
                {
                  title: "IA com propósito",
                  body: "LLMs e agentes como ferramentas, não como fim.",
                },
        ...
        <div className="reveal flex flex-col gap-12 lg:flex-row lg:items-start lg:gap-24">
          ...
          <div className="lg:w-[38%] lg:shrink-0">
            ...
            <p className="mt-6 text-sm leading-7 text-muted-foreground">
              Ferramentas e tecnologias que uso para transformar ideias em produtos reais — do
              backend à IA.
            </p>
              ...
              >
                ...
                >
                  {group.skills.map((skill, si) => (
                    <li key={skill} role="listitem" className="group flex items-center gap-5">
...
/** Individual project row — editorial list style */
function ProjectRow({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <div
      className={`group relative border-t transition-colors duration-300 ${
        project.wip
          ? "border-dashed border-amber-500/30"
          : project.featured
            ? "border-primary/20 border-solid"
            : "border-border/60 border-solid"
      }`}
    >
      {/* ── WIP: shimmer sweep on the top border ── */}
      {project.wip && (
        <span
          aria-hidden="true"
          className="absolute inset-x-0 top-0 h-px animate-wip-shimmer bg-gradient-to-r from-transparent via-amber-400/70 to-transparent"
        />
      )}
      ...
      >
        ...
        {/* WIP badge — pulsing dot + label */}
        {project.wip && (
          <span
            className="hidden shrink-0 items-center gap-1.5 rounded-full border border-amber-500/25 bg-amber-500/8 px-2.5 py-0.5 font-mono text-[10px] uppercase tracking-[0.12em] text-amber-400 sm:inline-flex"
            aria-label="Projeto em desenvolvimento"
          >
            <span className="relative flex h-1.5 w-1.5" aria-hidden="true">
              <span className="animate-ping-slow absolute inline-flex h-full w-full rounded-full bg-amber-400 opacity-70" />
        ...
        <h3 className="flex-1 text-base font-bold tracking-tight text-foreground transition-colors duration-200 group-hover:text-primary sm:text-lg md:text-xl">
          {project.name}
          {/* Mobile-only WIP indicator (inline after title) */}
          {project.wip && (
            <span
              className="ml-2 inline-flex items-center gap-1 align-middle sm:hidden"
      ...
      >
        <div className="flex flex-col gap-6 pb-7 pl-0 sm:flex-row sm:items-end sm:justify-between sm:pl-[52px]">
          ...
          <div className="flex shrink-0 flex-col items-start gap-3 sm:items-end">
            ...
            {project.wip ? (
              /* WIP: status pill instead of link — repo not finished yet */
              <div className="inline-flex items-center gap-2 rounded-lg border border-amber-500/25 bg-amber-500/6 px-4 py-2 font-mono text-xs text-amber-400/80">
                <span className="relative flex h-1.5 w-1.5 shrink-0" aria-hidden="true">
                  <span className="animate-ping-slow absolute inline-flex h-full w-full rounded-full bg-amber-400 opacity-60" />
                  <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-amber-400" />
                </span>
        ...
        <div className="reveal flex flex-col justify-between gap-8 sm:flex-row sm:items-end">
          ...
          <div className="flex flex-col items-start gap-3 sm:items-end">
            <p className="max-w-xs text-right text-sm leading-6 text-muted-foreground">
              {projects.length} projetos que refletem minha forma de pensar e construir.
            </p>
            <a
              href="https://github.com/matheus3881"
              target="_blank"
    ...
    <section id="contato" className="border-t border-border/60">
      <div className="mx-auto max-w-6xl px-5 py-24 lg:px-8 lg:py-32">
        ...
        <div className="reveal flex flex-wrap items-center justify-between gap-4">
          <p className="font-mono text-xs uppercase tracking-[0.15em] text-primary">04 / Contato</p>
